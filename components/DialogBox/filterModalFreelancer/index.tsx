...
export function FilterModalFreelancer({ open, handleClose,reFetch,setPage }: IFilterModal) {
                ...
                <Stack direction={"row"} justifyContent={"space-between"} gap={"50px"} paddingBottom={"20px"}>
                    ...
                    <FormControl>
                        ...
                        >
                            ...
                            <FormControlLabel value="Bid In Progress" control={<Radio />} label="In Progress" />
                        </RadioGroup>
                    </FormControl>
                </Stack>
