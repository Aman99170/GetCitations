    ...
    return (
        <>
            ...
            >
                ...
                <Typography variant="body1" color="textSecondary" pl={{ xs: '10px', sm: '20px', md: '40px' }}>
                    {userType === 'Researcher'
                    ...
                    <Stack direction="row" gap="10px">
                        ...
                        <Stack>
                            <TextField
                                ...
                                sx={{
                                    minWidth: { xs: '250px', sm: '350px', md: '500px' },
                                }}
                                type={fieldname.type ?? fieldname.type}
                            />
                            <Typography color="red" pl="5px">
                                {errors[fieldname.value as keyof IFormField]
                                    ? `${errors[fieldname.value as keyof IFormField]?.message}`
                                    : ''}
                            </Typography>
                        </Stack>
                    </Stack>
            ...
            <Stack
                ...
                gap="10px"
                sx={{
                    padding: { xs: '20px 0', sm: '30px 0', md: '36px 0 67px 114px' },
                }}
            >
                <Button
                    variant="contained"
